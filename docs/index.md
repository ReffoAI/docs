...
hero:
  name: Pelagora Docs
  tagline: Developer documentation for the open source network for peer-to-peer commerce.
  actions:
    - theme: brand
      text: Get Started
...
<div class="home-cards">
  <a class="home-card" href="/getting-started/quick-start">
    <span class="home-card-icon">🚀</span>
    <span class="home-card-title">Quick Start</span>
    <span class="home-card-detail">Get a Beacon running in under 5 minutes. Install, configure, and publish your first Ref to the network.</span>
  </a>
  <a class="home-card" href="/getting-started/architecture">
    <span class="home-card-icon">🏗️</span>
    <span class="home-card-title">Architecture Overview</span>
    <span class="home-card-detail">Understand how Beacons, the PIM protocol, and DHT discovery work together to form the network.</span>
  </a>
  <a class="home-card" href="/guides/building-skills">
    <span class="home-card-icon">🧩</span>
    <span class="home-card-title">Build a Skill</span>
    <span class="home-card-detail">Extend your Beacon with custom Skills — add new routes, MCP tools, and DHT message handlers.</span>
  </a>
</div>
...
<div class="glossary-list">
  ...
  <a class="glossary-item" href="/guides/building-skills">
