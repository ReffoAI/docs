...
| `locationCity` | no | — | City override (uses node default if empty) |
...
| Field | Required | Default | Description |
|---|---|---|---|
| `refId` | yes | — | The ref being offered on |
...
```json
{
  ...
  "buyerBeaconId": "buyer-node-pubkey",
  "sellerBeaconId": "seller-node-pubkey",
  "price": 17000,
  "priceCurrency": "USD",
...
Searches across all connected peers via DHT.
...
Nodes communicate over Hyperswarm using JSON messages:
...
Sent when a node joins the topic or periodically:
